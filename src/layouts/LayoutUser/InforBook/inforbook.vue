<template>
    <div class='inforbook-wrapper'>
        <div class='inforbook-title'>
            <p class='border-bottom p-3'>TỔNG QUAN</p>
        </div>
        <!-- chưa hiển thị details -->
        <div class='inforbook border p-3 my-4' 
            ...
            <div class='inforbook-content' v-if="book.isActive == null">
                ...
                <p>
                    <strong>Số thứ thự trên kệ sách:</strong> {{book.stt}}/{{book.soke}}/{{book.tenday}} - STT/SOKE/TENDAY
                </p>
                <p>
                    ...
                    <button   v-else
                            class='btn btn-success btn-small fs-5 rounded-pill px-3 ms-3'>
                        Còn sách
                    </button>
                </p>
            </div>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-small fs-5 rounded-pill px-3">
                                    {{book.trangthai}}
                                </button>
                            </td>
                        </tr>
